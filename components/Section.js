...
Instead, it’s a utility class that serves a specific purpose: to add elements to the DOM. 
...
3.It has a public method named renderItems() that renders all elements on the page. 
  a. it should iterate through the items array and call the renderer() function on each item. 
